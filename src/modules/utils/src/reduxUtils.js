...
// ACTION OBJECT
export function actionType(arrgs: Array<string>, prefix: string): Object {
...
export const FETCH_CYCLE = ASYNC_COMMON.map((c: string): string => joinArrayWithSeperator('_', ['RECEIVE', c]))
...
export const asyncActions = { FETCH_CYCLE, UPDATE_CYCLE, DELETE_CYCLE }
